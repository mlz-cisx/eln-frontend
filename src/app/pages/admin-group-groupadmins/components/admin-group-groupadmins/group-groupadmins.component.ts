...
import {
  AdminGroupsGroupadminsService
} from "@app/services/admin_users/admin-groups-groupadmins.service";
import {
  AdminGroupsService
...
export class GroupGroupadminsComponent implements OnInit {
  ...
  public constructor(
    ...
    public readonly admin_groupadmins_service: AdminGroupsGroupadminsService,
  ...
  public openNewModal(): void {
    ...
    //   closeButton: false,
    //   data: {service: this.admin_groupadmins_service, initialState: initialState},
    // });
    //
