...
export const mockLabBookNoteElement: LabBookElement<Note> = {
  ...
  height: 7,
  labbook_id: '91e3368b-8046-4515-970d-1332a73aa4d4',
...
export const mockLabBookPluginInstanceElement: LabBookElement<PluginInstance> = {
  ...
  labbook_id: '2c37da75-9100-4748-8045-ea2e55ef4759',
  num_relations: 0,
};
...
export const mockLabBookVersion: Version = {
  ...
  number: 1,
  object_id: 'e7856f1e-1b77-4eef-a042-522aba652ec6',
  created_by: mockUser,
  metadata: {
    title: 'Test LabBook',
    metadata: [],
  ...
  pk: 'e7856f1e-1b77-4eef-a042-522aba652ec6',
